...
export declare const getKeyValueByIndex: (properties: PropertiesData, index: number, parentPath?: string) => {
    key: string | number;
    data: any;
};
...
export declare type InsertDataType = Array<any> | Object | any;
export declare const addItemByIndex: (properties: PropertiesData, data: InsertDataType, index?: number, parentPath?: string) => PropertiesData | undefined;
