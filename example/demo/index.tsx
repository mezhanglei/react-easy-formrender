    ...
    return (
      <div>
        {/* <Form store={this.store}>
                    <RenderFormChildren watch={watch} controls={defaultControls} properties={this.state.properties} />
                </Form> */}
        <RenderForm components={{ row: Row, col: Col }} inside={{ type: 'row' }} watch={watch} controls={defaultControls} store={this.store} properties={this.state.properties} />
